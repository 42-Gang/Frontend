...
const ActionButton = () => {
	...
	const buttons = [
		{ label: "AUTO", onClick: () => navigate('/') },
		{ label: "CUSTOM", onClick: () => navigate('/') },
		{ label: "BACK", onClick: () => navigate('/Home') }
	]

	const buttonClass = "border-white w-[310px] h-[63px] border-4 rounded-3xl group cursor-pointer hover:bg-gray-600 hover:text-yellow-300 transition-colors duration-300"
