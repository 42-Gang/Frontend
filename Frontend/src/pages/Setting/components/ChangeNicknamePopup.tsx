...
const ChangeNicknamePopup: React.FC<ChangeNicknamePopupProps> = ({ onClose, onChangeNickname }) => {
	...
	return (
		<div className="bg-white w-[602px] h-[256px] rounded-lg fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col justify-center items-center">
			<button onClick={onClose} className="cursor-pointer absolute top-[6px] right-[6px]">
			...
			/>
			<button
				className="cursor-pointer absolute top-[175px] rounded-2xl bg-[var(--827E7C)] text-white w-[232px] h-[63px] opacity-70 hover:opacity-100"
