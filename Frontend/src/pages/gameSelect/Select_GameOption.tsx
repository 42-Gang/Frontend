            ...
            <div className="w-[800px] h-[600px] bg-black">
                ...
                <div className="flex flex-col items-center mt-1 gap-1 ml-[-105px] text-white font-['StWinterPixel24BoldDemoBold'] text-4xl tracking-[5px]">
                    <button className="mt-6 cursor-pointer flex items-center relative group">
                        <img src={Bullet} className="opacity-0 group-hover:opacity-100 transition-opacity duration-300"/>
                        <img
                    ...
                    <button className="mt-6 cursor-pointer flex items-center relative group">
                        ...
                        onClick={handleCustomClick}>CUSTOM</span>
                    </button>
                    <button className="mt-6 cursor-pointer flex items-center relative group">
                        <img src={Bullet} className="opacity-0 group-hover:opacity-100 transition-opacity duration-300"/>
                        <img
                        ...
                        />
                        <span className="absolute right-25 group-hover:text-yellow-300" onClick={handleBackClick}>BACK</span>
                    </button>
                </div>
